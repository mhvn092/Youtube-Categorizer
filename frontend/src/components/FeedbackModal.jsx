...
export default function FeedbackModal({ video, isOpen, onClose, onSubmitFeedback }) {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setLoading(true);
    await onSubmitFeedback(video.id, 'skip', reason.trim());
    setLoading(false);
    setReason('');
    onClose();
  };
      ...
      <div className="glass-panel animate-fade-in" style={{ width: '100%', maxWidth: '500px', padding: '24px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <h2 style={{ fontSize: '1.15rem', fontWeight: 600 }}>Train AI: Why are you skipping?</h2>
          </div>
        ...
        <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)', marginBottom: '16px' }}>
          Skipping <strong>"{video.title}"</strong>. Help the AI learn your background so future recommendations are more accurate.
        </p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <textarea
              rows={3}
              placeholder="e.g. I already know advanced Rust async, don't recommend beginner tutorials..."
              value={reason}
